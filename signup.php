...
<head>
  ...
  <title>Sign Up | Free Your Inbox</title>
...
<link rel="icon" type="image/png" href="https://freeyourinbox.com/img/favicon-128.png" sizes="128x128"/>
  ...
  <link rel="stylesheet" href="css/master.css?v=13">
</head>
...
<body>
  ...
  <div class="container login-page">
    ...
    <div>
      ...
      <h3 class="login-subtitle">You're just a few clicks away from getting a sane inbox</h3>
    </div>

    <div class="col-md-6 col-md-offset-3 wow fadeInUp">
      <div class="login-panel">
        <div id="gmail" class="login-button login-gmail signup"><img src="img/icon/google.png" class="img-responsive">
        ...
        <div id="other" class="login-other"><input type="checkbox" id="agree"> <label for="agree">I agree to the <a href="/tos" target="_blank">terms of service</a> and <a href="/privacy" target="_blank">privacy policy</a></label></div>
        <div class="loader">
  ...
  <script src="js/app.js?v=18" charset="utf-8"></script>
</body>
