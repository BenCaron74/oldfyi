    ...
    <div class="header-brand">
      ...
      <div class="header-user">
        <ul>
          ...
          <li><img class="user-img" src="testPic/user.png" alt=""></li>
        </ul>
      </div>
    </div>
  ...
  <div class="content">
    ...
    <div id="pNew" class="">
      ...
      <section class="cards-blocked">
        <div class="container">
          <h4 class="context-title">Blocked</h4>
        </div>
      ...
      <section class="cards-allowed">
        <div class="container">
          <h4 class="context-title yolMobile">Allowed</h4>
        </div>
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
      ...
      <section class="cards-new">
        <div class="container">
          <h4 class="context-title yolMobile">New</h4>
        </div>
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
      ...
      <div class="modal-card-content">
        ...
        <hr>
        <ul id="modalGoDigest">
          <li class="ion-android-archive"></li>
          <li>Digest</li>
        </ul>
      </div>
    </div>
