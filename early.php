...
<body>
  ...
  <div class="container login-page">
      ...
      <div class="sub-panel">
        ...
        <div id="after">
          ...
          <div class="btn-group-wrap">
            ...
            <div class="btn-group" role="group" aria-label="...">
              ...
              <button type="button" class="btn btn-instagram"><span class="ion-social-instagram"></span></button>
            </div>
          </div>
        </div>
        ...
        <div class="loader">
          <svg version="1.1" id="L5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 0 0" xml:space="preserve">
            <circle fill="#1e88e5" stroke="none" cx="6" cy="50" r="6">
              <animateTransform
            ...
            <circle fill="#1e88e5" stroke="none" cx="54" cy="50" r="6">
              <animateTransform
                 attributeName="transform"
                 dur="1s"
                 type="translate"
    ...
    <div id="home">Back to <a href="/">home</a></div>
