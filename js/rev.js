...
// updateLists(["blocked", "allowed", "digest"], false);
  ...
  $('.ion-thumbsdown').click(function(){
    var cardPlus = $(this).parents().find('.carde-menu');
    var cardInfo = $(this).parents().find('.carde-info');
    if (cardPlus.is(':visible')) {
      cardPlus.slideUp(400, function(){
        cardInfo.slideDown(200);
      });
    } else {
      cardInfo.slideUp(200, function(){
        cardPlus.slideDown(400);
      });
    }
  });
